        ...
        <div id="login-row" class="row justify-content-center align-items-center">
            <div id="login-column" class="col-md-6">
                <div id="login-box" class="col-md-12">
                    <h3 class="text-center" style="color: darkblue"><fmt:message key="label.cabinet"/></h3>
                    ...
                    <form method="POST" action="cabinet">
                        ...
                        <div class="form-group">
                            <label for="oldPassword" style="font-weight: 600; font-size: 18px; color: darkblue">
                  ...
                  <i class="fas fa-eye-slash d-none" id="hide_eye"></i>
                        ...
                        <div class="form-group">
                            <label for="password" style="font-weight: 600; font-size: 18px; color: darkblue">
                                <fmt:message key="label.newPassword"/>:</label><br>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                ...
                <span class="input-group-text" onclick="password_show_hide3();">
                  ...
                  <i class="fas fa-eye-slash d-none" id="hide_eye3"></i>
                        ...
                        <div class="text-center">
                            ...
                            <p style="font-weight: 600; font-size: 18px; color: red">${errorOldPass}</p>
                            <p style="font-weight: 600; font-size: 18px; color: red">${confirmEdit}</p>
                        </div>
                        ...
                        <c:if test="${correctUsers == true}">
                            <div id="register-link" class="text-right">
                                <a href="/users"><fmt:message key="label.changeParameterUser"/></a>
                            </div>
                        </c:if>
                    </form>
                </div>
